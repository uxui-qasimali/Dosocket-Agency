...
function SplashCursor({
  ...
  BACK_COLOR = { r: 0.02, g: 0.12, b: 0.1 }, 
  TRANSPARENT = false
}) {
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Custom color generation for teal/aqua range
      // Hue range around 160-180 degrees (approx 0.44 - 0.5 in 0-1 range)
      let c = HSVtoRGB(0.4 + Math.random() * 0.15, 0.8, 0.9);
      // Brightness boost
      c.r *= 0.8;
      c.g *= 0.8;
      c.b *= 0.8;
